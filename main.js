(() => {
  const copy = {
    ar: {
      ...
      footerLine: "للمناسبات التي تبقى في الذاكرة.", footerExplore: "استكشف", footerContact: "تواصل معنا", copyright: "قاعة الشرق الأوسط للإحتفالات", backTop: "العودة للأعلى ↑",
      galleryPageTitle: "معرض القاعة", galleryPageIntro: "جولة بصرية في أجواء قاعة الشرق الأوسط وتفاصيلها؛ تصفحوا الصور ومقاطع الفيديو.", photos: "الصور", videos: "الفيديوهات", galleryCredit: "مصدر مواد المعرض:", sourceName: "عالم زفاف",
    ...
    en: {
      ...
      footerLine: "For celebrations that stay with you.", footerExplore: "Explore", footerContact: "Contact", copyright: "Middle East Celebrations Hall", backTop: "Back to top ↑",
      galleryPageTitle: "The gallery", galleryPageIntro: "Explore the atmosphere and details of Middle East Celebrations Hall through photos and videos.", photos: "Photos", videos: "Videos", galleryCredit: "Gallery media source:", sourceName: "Zafaf World",
